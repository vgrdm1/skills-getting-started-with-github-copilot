...
activities = {
    ...
    "Track and Field": {
        "description": "Sprint, distance, and field events for athletes of all levels",
    ...
    "Music Ensemble": {
        "description": "Join choir, orchestra, or band and perform at school events",
...
def signup_for_activity(activity_name: str, email: str):
    ...
    # validate that a student is not already signed up
